...
面向**高分子材料加工**领域的智能研究情报平台。通过 Agent 自主搜索 + Bocha 搜索引擎 + RSS 订阅，每天自动生成高质量中文日报，覆盖塑料、橡胶、纤维三个材料方向，AI 相关内容独立为 AI日报。
...
| **三分类日报** | 塑料 / 橡胶 / 纤维，按材料方向分板块；AI 独立为 AI日报 |
