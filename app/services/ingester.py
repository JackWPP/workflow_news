...
def _build_search_query_specs() -> list[dict[str, str]]:
    ...
    return [
        _spec("注塑机 新品发布", language="zh", section="industry", category="塑料", query_family="equipment_news"),
        _spec("挤出设备 技术升级", language="zh", section="industry", category="塑料", query_family="equipment_news"),
        _spec("高分子材料 产能扩建", language="zh", section="industry", category="塑料", query_family="capacity_news"),
        _spec("塑料原料 价格行情", language="zh", section="industry", category="塑料", query_family="market_watch"),
        _spec("复合材料 汽车轻量化", language="zh", section="industry", category="塑料", query_family="application_news"),
        _spec("改性塑料 应用", language="zh", section="industry", category="塑料", query_family="application_news"),
        _spec("锂电池 隔膜 材料", language="zh", section="industry", category="塑料", query_family="energy_materials"),
        _spec("光伏 胶膜 封装材料", language="zh", section="industry", category="塑料", query_family="energy_materials"),
        _spec("氢能 质子交换膜", language="zh", section="industry", category="塑料", query_family="energy_materials"),
        _spec("PLA 聚乳酸 降解", language="zh", section="industry", category="塑料", query_family="biopolymer"),
        _spec("PBAT 生物降解塑料", language="zh", section="industry", category="塑料", query_family="biopolymer"),
        _spec("3D打印 高分子材料", language="zh", section="industry", category="塑料", query_family="advanced_processing"),
        _spec("导电高分子", language="zh", section="academic", category="塑料", query_family="research_signal"),
        _spec("限塑令 最新政策", language="zh", section="policy", category="塑料", query_family="policy"),
        _spec("碳关税 塑料行业", language="zh", section="policy", category="塑料", query_family="policy"),
        _spec("环保法规 高分子材料", language="zh", section="policy", category="塑料", query_family="policy"),
        _spec("塑料 回收 循环经济", language="zh", section="policy", category="塑料", query_family="policy"),
        _spec("高分子改性 研究进展", language="zh", section="academic", category="塑料", query_family="research_signal"),
        _spec("聚合物 新材料 论文", language="zh", section="academic", category="塑料", query_family="research_signal"),
        _spec("北京化工大学 英蓝实验室 高分子 研究", language="zh", section="academic", category="塑料", query_family="lab_watch"),
        _spec("英蓝云展 高分子材料 加工技术", language="zh", section="industry", category="塑料", query_family="lab_watch"),
        _spec("injection molding machine new product", language="en", section="industry", category="塑料", query_family="equipment_news"),
        _spec("polymer processing equipment innovation", language="en", section="industry", category="塑料", query_family="equipment_news"),
        ...
        _spec("plastics recycling technology breakthrough", language="en", section="industry", category="塑料", query_family="recycling"),
        _spec("EU plastic regulation policy", language="en", section="policy", category="塑料", query_family="policy"),
        _spec("microplastics regulation polymer", language="en", section="policy", category="塑料", query_family="policy"),
        _spec("polymer composite materials science research", language="en", section="academic", category="塑料", query_family="research_signal"),
        _spec("biodegradable polymer technology", language="en", section="academic", category="塑料", query_family="biopolymer"),
        _spec("additive manufacturing polymer", language="en", section="industry", category="塑料", query_family="advanced_processing"),
        _spec("轮胎 行业动态 产能", language="zh", section="industry", category="橡胶", query_family="rubber_industry"),
        _spec("合成橡胶 价格 行情", language="zh", section="industry", category="橡胶", query_family="rubber_market"),
        _spec("弹性体 TPU TPE 新材料", language="zh", section="industry", category="橡胶", query_family="rubber_materials"),
        _spec("碳纤维 应用 产业化", language="zh", section="industry", category="纤维", query_family="fiber_industry"),
        _spec("化学纤维 涤纶 锦纶 行情", language="zh", section="industry", category="纤维", query_family="fiber_market"),
        _spec("芳纶 高性能纤维 应用", language="zh", section="industry", category="纤维", query_family="fiber_materials"),
        _spec("纺丝 工艺 技术 突破", language="zh", section="academic", category="纤维", query_family="fiber_research"),
        _spec("rubber tire industry news", language="en", section="industry", category="橡胶", query_family="rubber_industry"),
        _spec("carbon fiber application industry", language="en", section="industry", category="纤维", query_family="fiber_industry"),
    ]
